        ...
        <div class="m-account-w" data-bg-img="assets/img/account/wrapper-bg.jpg">
            <div class="m-account">
                <div class="row no-gutters">
                    <div class="col-md-6">
                        <!-- Login Content Start -->
                        <div class="m-account--content-w" data-bg-img="assets/img/account/rambu.jpg">
                        </div>
                        <!-- Login Content End -->
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="m-account--form-w">
                            <div class="m-account--form">
                                ...
                                <form action="proses_login.php" method="post">
                                    <label class="m-account--title">Silakan Login</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" id="btn" class="btn btn-rounded btn-info" name="login">Login</button>
                                    <div class="m-account--footer">
                                        <p>&copy; 2020 @Politala - AnggrainiDianS</p>
                                    </div>
                                </form>
                            </div>
                        </div>
